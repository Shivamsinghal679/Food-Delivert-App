...
<body>
    ...
    <div class="d-flex justify-content-between mb-2">
        ...
        <a class="btn btn-success" href="Menu3.php">Go To Menu</a>
        <a class="btn btn-danger" href="Cart3.php?action=empty">Remove All Items</a>
    </div>
    <div class="row">
        ...
        <table class="table">
            ...
            <tr>
                ...
                <td class="text-center"><a class="btn btn-danger" href="Cart3.php?action=remove&Id=<?=$item['id'];?>">X</a></td>
            </tr>
            <?php
